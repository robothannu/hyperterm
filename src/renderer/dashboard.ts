...
// Sprint 3: discovery state (`_discoveryCandidates`, `_discoveryDismissed`)
// + banner/modal logic lives in dashboard-discovery.ts.
...
if (typeof window !== "undefined") {
  ...
  // Sprint 3: discovery modal wiring lives in dashboard-discovery.ts
  initDiscoveryModalControls();
